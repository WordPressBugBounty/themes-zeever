 ...
 */
return array(
	'title'      => __( 'Index Hero Title', 'zeever' ),
...
<div class="wp-block-column"><!-- wp:post-title {"textAlign":"center","textColor":"gv-color-dark-text-primary","fontSize":"heading-2","fontFamily":"cambria-georgia"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
