...
return array(
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"100px","bottom":"60px"},"margin":{"top":"0px","bottom":"0px"}}},"backgroundColor":"gv-color-dark-background-primary","layout":{"wideSize":"1170px","contentSize":"1170px","type":"constrained"}} -->
<div class="wp-block-group has-gv-color-dark-background-primary-background-color has-background" style="margin-top:0px;margin-bottom:0px;padding-top:100px;padding-bottom:60px"><!-- wp:columns {"style":{"spacing":{"padding":{"right":"10px","left":"10px"}}}} -->
...
<div class="wp-block-column"><!-- wp:heading {"textAlign":"left","className":"is-style-lineseparator zeever-animate zeever-move-right zeever-delay-1","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white","fontSize":"heading-2"} -->
...
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --><!-- wp:group {"style":{"spacing":{"padding":{"bottom":"100px","top":"0px","right":"32px","left":"32px"},"margin":{"top":"0px","bottom":"0px"}},"color":{"background":"#121212"}},"layout":{"type":"default"}} -->
<div class="wp-block-group has-background" style="background-color:#121212;margin-top:0px;margin-bottom:0px;padding-top:0px;padding-right:32px;padding-bottom:100px;padding-left:32px"><!-- wp:columns {"align":"full","style":{"spacing":{"blockGap":{"left":"24px"}}}} -->
<div class="wp-block-columns alignfull"><!-- wp:column {"className":"zeever-animate zeever-move-up zeever-delay-1","style":{"spacing":{"blockGap":"16px"}}} -->
<div class="wp-block-column zeever-animate zeever-move-up zeever-delay-1"><!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"80px","left":"40px"},"blockGap":"24px"},"border":{"radius":{"topLeft":"0px","topRight":"0px","bottomLeft":"0px","bottomRight":"0px"},"style":"solid","width":"1px"}},"backgroundColor":"gv-color-dark-background-secondary","borderColor":"gv-color-dark-border"} -->
<div class="wp-block-group has-border-color has-gv-color-dark-border-border-color has-gv-color-dark-background-secondary-background-color has-background" style="border-style:solid;border-width:1px;border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:0px;border-bottom-right-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:80px;padding-left:40px"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":136,"width":"60px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="' . esc_url( trailingslashit( get_template_directory_uri() ) ) . 'assets/img/quote.webp" alt="" class="wp-image-136" style="width:60px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:paragraph {"align":"center","textColor":"gv-color-dark-text-secondary","fontSize":"tiny"} -->
<p class="has-text-align-center has-gv-color-dark-text-secondary-color has-text-color has-tiny-font-size"><em>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque consequat bibendum turpis sit amet pretium. Nunc ut dui ornare, vulputate augue sed, varius velit.</em></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:column {"className":"zeever-animate zeever-move-up zeever-delay-3","style":{"spacing":{"blockGap":"16px"}}} -->
<div class="wp-block-column zeever-animate zeever-move-up zeever-delay-3"><!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"80px","left":"40px"},"blockGap":"24px"},"border":{"radius":{"topLeft":"0px","topRight":"0px","bottomLeft":"0px","bottomRight":"0px"},"style":"solid","width":"1px"}},"backgroundColor":"gv-color-dark-background-secondary","borderColor":"gv-color-dark-border"} -->
<div class="wp-block-group has-border-color has-gv-color-dark-border-border-color has-gv-color-dark-background-secondary-background-color has-background" style="border-style:solid;border-width:1px;border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:0px;border-bottom-right-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:80px;padding-left:40px"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":136,"width":"60px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="' . esc_url( trailingslashit( get_template_directory_uri() ) ) . 'assets/img/quote.webp" alt="" class="wp-image-136" style="width:60px"/></figure>
...
<!-- wp:column {"className":"zeever-animate zeever-move-up zeever-delay-5","style":{"spacing":{"blockGap":"16px"}}} -->
<div class="wp-block-column zeever-animate zeever-move-up zeever-delay-5"><!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"80px","left":"40px"},"blockGap":"24px"},"border":{"radius":{"topLeft":"0px","topRight":"0px","bottomLeft":"0px","bottomRight":"0px"},"style":"solid","width":"1px"}},"backgroundColor":"gv-color-dark-background-secondary","borderColor":"gv-color-dark-border"} -->
<div class="wp-block-group has-border-color has-gv-color-dark-border-border-color has-gv-color-dark-background-secondary-background-color has-background" style="border-style:solid;border-width:1px;border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:0px;border-bottom-right-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:80px;padding-left:40px"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":136,"width":"60px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="' . esc_url( trailingslashit( get_template_directory_uri() ) ) . 'assets/img/quote.webp" alt="" class="wp-image-136" style="width:60px"/></figure>
...
<!-- wp:column {"className":"zeever-animate zeever-move-up zeever-delay-7","style":{"spacing":{"blockGap":"16px"}}} -->
<div class="wp-block-column zeever-animate zeever-move-up zeever-delay-7"><!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"80px","left":"40px"},"blockGap":"24px"},"border":{"radius":{"topLeft":"0px","topRight":"0px","bottomLeft":"0px","bottomRight":"0px"},"style":"solid","width":"1px"}},"backgroundColor":"gv-color-dark-background-secondary","borderColor":"gv-color-dark-border"} -->
<div class="wp-block-group has-border-color has-gv-color-dark-border-border-color has-gv-color-dark-background-secondary-background-color has-background" style="border-style:solid;border-width:1px;border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:0px;border-bottom-right-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:80px;padding-left:40px"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":136,"width":"60px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="' . esc_url( trailingslashit( get_template_directory_uri() ) ) . 'assets/img/quote.webp" alt="" class="wp-image-136" style="width:60px"/></figure>
