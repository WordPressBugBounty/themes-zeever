 ...
 */
return array(
	'title'      => __( 'Search Hero Title', 'zeever' ),
	'categories' => array( 'zeever-core' ),
	'content'    => '<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"inherit":false}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"160px"},"blockGap":"20px"}},"layout":{"wideSize":"1170px","contentSize":"1170px","type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:160px"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:query-title {"type":"search","textAlign":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|gv-color-dark-text-primary"}}}},"textColor":"gv-color-dark-text-primary","fontSize":"heading-2"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:separator {"style":{"layout":{"selfStretch":"fixed","flexSize":"100px"}},"backgroundColor":"gv-color-dark-primary"} -->
<hr class="wp-block-separator has-text-color has-gv-color-dark-primary-color has-alpha-channel-opacity has-gv-color-dark-primary-background-color has-background"/>
<!-- /wp:separator --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
