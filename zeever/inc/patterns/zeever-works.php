 ...
 */
return array(
	'title'      => __( 'Works', 'zeever' ),
	'categories' => array( 'zeever-core' ),
	'content'    => '<!-- wp:group {"style":{"color":{"background":"#121212"},"spacing":{"padding":{"top":"100px","bottom":"60px"},"margin":{"top":"0px","bottom":"0px"}}},"layout":{"wideSize":"1170px","contentSize":"1170px","type":"constrained"}} -->
<div class="wp-block-group has-background" style="background-color:#121212;margin-top:0px;margin-bottom:0px;padding-top:100px;padding-bottom:60px"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"right":"10px","left":"10px"}}}} -->
<div class="wp-block-columns are-vertically-aligned-center" style="padding-right:10px;padding-left:10px"><!-- wp:column {"verticalAlignment":"center"} -->
...
<div class="wp-block-column"><!-- wp:heading {"textAlign":"left","className":"is-style-lineseparator zeever-animate zeever-move-right zeever-delay-1","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"gv-color-dark-text-primary","fontSize":"heading-2"} -->
...
<div class="wp-block-buttons"><!-- wp:button {"textColor":"zeever-primary","className":"is-style-custombuttonborder3 zeever-animate zeever-move-left zeever-delay-1","style":{"spacing":{"padding":{"top":"18px","bottom":"18px","left":"30px","right":"30px"}},"elements":{"link":{"color":{"text":"var:preset|color|uLAbtE"}}}},"borderColor":"zeever-secondary"} -->
<div class="wp-block-button is-style-custombuttonborder3 zeever-animate zeever-move-left zeever-delay-1"><a class="wp-block-button__link has-zeever-primary-color has-text-color has-link-color has-border-color has-zeever-secondary-border-color wp-element-button" href="#" style="padding-top:18px;padding-right:30px;padding-bottom:18px;padding-left:30px">VIEW ALL →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
